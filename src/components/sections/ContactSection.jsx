            ...
            <div className="pt-4 border-t border-white/5 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2 font-mono text-xs">
                <a
                  ...
                  onMouseEnter={() => sound.playHover()}
                  data-cursor="VIEW"
                  className="flex items-center gap-2 p-2.5 rounded-xl bg-zinc-900/50 border border-white/5 hover:border-red-500/40 text-zinc-300 hover:text-red-400 transition-colors"
                >
                ...
                <a
                  ...
                  onMouseEnter={() => sound.playHover()}
                  data-cursor="VIEW"
                  className="flex items-center gap-2 p-2.5 rounded-xl bg-zinc-900/50 border border-white/5 hover:border-pink-500/40 text-zinc-300 hover:text-pink-400 transition-colors"
                >
                ...
                <a
                  ...
                  onMouseEnter={() => sound.playHover()}
                  data-cursor="VIEW"
                  className="flex items-center gap-2 p-2.5 rounded-xl bg-zinc-900/50 border border-white/5 hover:border-sky-500/40 text-zinc-300 hover:text-sky-400 transition-colors"
                >
